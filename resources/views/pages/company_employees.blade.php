        ...
        <div id="blinq-card" class="blinq-card">
            ...
            <div class="members">
                @foreach($employees as $employee)
                    <div class="info" data-href="{{ route('individual', $employee->security_key) }}">
                        <div class="img-body">
                            <img src="{{ $employee->contact->image() }}" alt="">
                        </div>
                        <div class="name">
                            <p>{{ $employee->contact->full_name}}</p>
                        </div>
                        <div class="position">
                            <p>{{ $employee->contact->position}}</p>
                        </div>
                    </div>
                @endforeach
            </div>
